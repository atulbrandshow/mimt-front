...
function CreateDynamicPages({ type, componentType, parentId }) {
    ...
    return (
        <div className="w-full">
            ...
            {showPageDetails && (
                <DynamicPageDetails allData={allData} parentPage={selectedPage} type={type} componentType={componentType} />
            )}
        </div>
    );
}
