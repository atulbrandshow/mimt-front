...
import { csePatentData, tableHeadings } from '@/Json/PatentsData';
...
const CsePatent = () => {
    ...
    const totalEntries = csePatentData.length;
    ...
    const displayedData = csePatentData.slice(startIndex, startIndex + itemsPerPage);
