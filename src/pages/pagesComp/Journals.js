...
const department = [
  {
    ...
    links: '/cse-department-journals',
  },
  {
    serialNumber: '2',
    title: 'Information Technology',
    links: '/it-department-journals',
  },
  {
    serialNumber: '3',
    title: 'Electronics & Communication Engineering',
    links: '/ece-department-journals',
  },
  {
    serialNumber: '4',
    title: 'Electrical & Electronics Engineering',
    links: '/en-department-journals',
  },
  {
    serialNumber: '5',
...
const Journals = () => {
  return (
    <div>
      <h3 className="text-5xl leading-none font-novaBold text-center mb-6">Journals</h3>
      <p className="text-lg font-novaSemi mb-8">Department Wise Journals Papers</p>
