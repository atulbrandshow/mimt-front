...
const department = [
  {
    ...
    links: '/cse-funded-projects',
  },
  {
    serialNumber: '2',
    title: 'Information Technology',
    links: '/it-funded-projects',
  },
  {
    serialNumber: '3',
    title: 'Electronics & Communication Engineering',
    links: '/ece-funded-projects',
  },
  {
    serialNumber: '4',
    title: 'Electrical & Electronics Engineering',
    links: '/en-funded-projects',
  },
  {
    serialNumber: '5',
    title: 'Mechanical Engineering',
    links: '/me-funded-projects',
  }
];
...
const FundedProjects = () => {
  return (
    <div>
      <h3 className="text-5xl leading-none font-novaBold text-center mb-6">Funded Projects</h3>
      <p className="text-lg font-novaSemi mb-8">Funded Projects</p>
