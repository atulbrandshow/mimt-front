...
export default function Page({ data }) {
  ...
  return (
    <div className="bg-white">
      ...
      <section className="w-full max-w-[1600px] mx-auto py-20 px-4 grid grid-cols-12 gap-10">
          ...
          <div className="bg-[#f9c80e] p-10 rounded-2xl shadow-xl">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <form className="space-y-4">
                ...
                <input className="w-full p-3 border rounded-lg" placeholder="Enter Name *" />
                <input className="w-full p-3 border rounded-lg" placeholder="Enter Email Address *" />

                <div className="flex gap-4">
                  <select className="w-28 p-3 border rounded-lg">
                    <option>+91</option>
                  </select>
                  <input className="w-full p-3 border rounded-lg" placeholder="Enter Mobile Number *" />
                </div>
                ...
                <button
                  type="button"
                  className="w-full bg-[#831d82] text-white py-3 text-lg rounded-lg font-semibold hover:bg-[#6b146a] transition"
                >
                  Submit
                </button>
        ...
        <div className="col-span-12 lg:col-span-5">
          ...
          <div className="relative bg-gradient-to-br from-[#8e0f8c] to-[#5b0461] text-white p-10 rounded-3xl shadow-2xl h-full flex flex-col justify-between">
            ...
            <h2 className="text-3xl font-bold mb-6 border-b border-white/20 pb-3 relative z-10">
              Contact Information
            </h2>

            {/* ✅ HTML Content Box */}
            <div
              className="text-lg leading-relaxed bg-white/10 p-6 rounded-2xl backdrop-blur-md shadow-inner relative z-10 space-y-3"
              dangerouslySetInnerHTML={{
                __html: p?.Contact_info_html || p?.Contact_info || ""
              }}
            />

            {/* ✅ Phone, Email, Address Icons */}
