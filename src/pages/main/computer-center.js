      ...
      <section className="w-full grid grid-cols-12 gap-10 max-sm:gap-0">
        <div className="bg-primary rounded-r-[50px] col-span-9 max-xl:col-span-8 max-lg:col-span-12">
          <div className="max-w-[1200px] ml-auto py-16 px-16">
            ...
            <div
              dangerouslySetInnerHTML={{ __html: data?.pageData?.ComputerCenterDescription }}
              className={`${descriptionCss} bg-gray-50 p-6 rounded-xl font-novaReg shadow-sm leading-relaxed text-[17px]`}
            />
            <section className="py-12">
              <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6 ">
                  <MIMTGallery data={data?.pageData?.ComputerCenterGallery} />
                </div>
              </div>
            </section>
          </div>
