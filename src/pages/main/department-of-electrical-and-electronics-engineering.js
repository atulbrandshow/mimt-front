        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className='mt-2 font-novaReg'>The scope of Electrical and Electronics Engineering continues to expand with rapid advancements in technology and increasing demand for smart, sustainable, and energy-efficient solutions. Graduates from this department have career opportunities in diverse sectors including power generation and distribution, renewable energy, electric vehicles, automation, robotics, control systems, embedded systems, and electronics design. With the rise of interdisciplinary fields like IoT, AI-driven hardware systems, and smart grids, EEE professionals are well-positioned to contribute to innovation across industries. The department equips students with the technical knowledge and problem-solving skills required to excel in core industries as well as in research, higher education, and entrepreneurship.</p>
            </div>
          </div>
        ...
        <div className="space-y-8">
          <div>
            <h1 className="text-2xl font-novaReg text-gray-800 mb-2">
              AKG University B.Tech EEE Admission Eligibility & Fees
            </h1>
