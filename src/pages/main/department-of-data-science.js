      ...
      <div className='relative h-[90vh] max-lg:h-full bg-cover'>
        ...
        <div className='relative max-w-[1400px] mx-auto h-full w-full grid grid-cols-3 px-10 max-sm:px-3'>
          <div className='col-span-1 flex flex-col justify-center max-lg:items-center text-white max-lg:col-span-3 max-lg:pt-40'>
            ...
            <h2 className='font-novaReg max-md:text-center text-3xl sm:text-4xl'>Data Science</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <p className="text-white font-novaReg leading-relaxed">
                The booming data economy offers exceptional opportunities for Data Science graduates. With expertise in analytics, machine learning, and big data technologies, our graduates are well-positioned for roles across industries. Data Scientists are in high demand in IT, finance, healthcare, e-commerce, and research sectors. Career paths include data analyst, machine learning engineer, business intelligence specialist, AI researcher, and data architect, with competitive salaries and rapid career growth potential in this high-growth field.
              </p>
            </div>
