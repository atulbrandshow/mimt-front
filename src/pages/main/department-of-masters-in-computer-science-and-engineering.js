        ...
        <section>
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <p className="my-5 tracking-tight font-novaReg text-start leading-5">
                                The MTech program in Computer Science at AKGU is designed to provide advanced technical knowledge and research skills in cutting-edge areas of computer science. Established in 2005, the department has been at
                                the forefront of research and innovation in specialized domains.
                            </p>
                            <p className="leading-5 text-start font-novaReg">
                                Our MTech program emphasizes both theoretical foundations and practical applications, with specializations available in Artificial Intelligence, Data Science, Cybersecurity, and Cloud Computing. The
                                department boasts state-of-the-art research facilities and collaborations with leading industry research labs. Students work closely with faculty on cutting-edge research projects, with opportunities to
                                publish in reputed journals and conferences.
                            </p>
                        </div>
                        <div>
                            <h2 className="font-novaReg text-2xl">Research Focus</h2>
                            <p className="mt-2 font-novaReg">
                                According to NASSCOM, India's AI/ML workforce is expected to grow at 30% CAGR, creating over 300,000 research-oriented positions by 2025. Our program prepares students for these high-growth research and
            ...
            <section className="relative bg-cover flex flex-col justify-between py-6 sm:py-20 md:py-32">
                ...
                <div className="relative max-w-4xl w-full mx-auto text-white text-center flex max-md:flex-col max-md:gap-5 items-center justify-between px-4 py-10">
                    <div>
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-novaBold max-w-lg leading-6 sm:leading-7">MTech IN COMPUTER SCIENCE</h2>
                        <span className="text-lg sm:text-xl md:text-2xl font-novaReg">Research Program Ranked Amongst</span>
                        <h1 className="text-2xl sm:text-4xl xl:text-6xl text-yellow-500 font-novaBold">TOP RESEARCH INSTITUTIONS</h1>
                    </div>
                    <div>
            ...
            <div className="max-w-[1400px] mx-auto p-6 grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="space-y-8">
                    <div>
                        <h1 className="text-2xl font-novaReg text-gray-800 mb-2">AKG University MTech CSE Admission Eligibility & Fees</h1>
                        <p className="text-gray-800 font-novaReg">
                            Applicants must have completed a BE/BTech in Computer Science/IT or equivalent with at least 60% aggregate marks. GATE qualified candidates are given preference. Candidates with relevant industry experience are
            ...
            <div className="w-full max-w-7xl mx-auto px-4 py-8">
                <h1 className="text-center text-3xl font-novaSemi mb-12 text-gray-800">Research Placement Achievements</h1>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <p className="text-white font-novaReg leading-relaxed">
                                MTech graduates in Computer Science have diverse opportunities in research and development across industries and academia. The growing demand for specialized technical expertise in AI, Data Science,
                                Cybersecurity, and Cloud Computing offers exciting career paths. Graduates can pursue roles as Research Scientists, Technical Architects, or pursue PhD programs at top institutions worldwide.
                            </p>
                        </div>
                        {/* Top Recruiters Section */}
                        <div>
                            <h2 className="text-2xl font-novaReg text-white mb-4">Leading Research Employers</h2>
                            <p className="text-white font-novaReg mb-4">Some of the leading research organizations hiring MTech graduates include:</p>
                ...
                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-12">
                    ...
                    <div className="relative h-[300px] md:h-full lg:col-span-4">
                        <div className="absolute inset-0 bg-red-600">
                            <Image src="/image/building/building5.webp" alt="Advanced Research Programs" className="h-full w-full object-cover object-left grayscale" width={500} height={600} priority />
                    ...
                    <div className="space-y-6 p-6 lg:col-span-4">
                        ...
                        <p className="text-gray-600 font-novaReg">
                            These programs equip students with deep technical expertise and research skills in emerging technology areas, providing them with an excellent platform to excel in research careers. It's an opportunity for
                            passionate researchers to work in a dynamic and challenging academic environment.
                        </p>
                    </div>
                    {/* Features Section */}
                    <div className="space-y-6 bg-gray-50 p-6 lg:col-span-4">
                        <h2 className="text-xl font-novaSemi text-gray-900">Key Research Highlights</h2>
