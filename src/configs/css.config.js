export const descriptionCss = `prose prose-lg max-w-none relative
  ...
  /* TABLE STYLING */
  prose-table:w-full prose-table:border-collapse prose-table:rounded-lg overflow-hidden prose-table:shadow-md prose-table:my-8
  prose-thead:bg-[#911e75] prose-thead:text-white
  prose-th:px-6 prose-th:bg-[#911e75] prose-th:text-white prose-th:py-4 prose-th:text-center prose-th:font-semibold prose-th:border prose-th:border-gray-300
  prose-td:px-6 prose-td:py-4 prose-td:text-center prose-td:border prose-td:border-gray-300 prose-td:text-gray-900 prose-td:font-medium
  prose-tr:even:bg-[#fffbea] prose-tr:odd:bg-white hover:prose-tr:bg-[#ffddf6] hover:prose-tr:text-white  transition-colors duration-200 ease-in-out
