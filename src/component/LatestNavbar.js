...
import { About, Academics, Admissions, CampusLife, ResearchInnovation, Placements, Programs } from "../Json/NavItem";
          ...
          <li className="relative group">
            ...
            <div
              className={`${BigMenuToggle ? "relative w-full bg-white/40" : "absolute w-[650px]"
                } ${openMenu === "placements" && "absolute h-auto mt-0 w-full"} left-0 h-0 mt-5 overflow-hidden lg:group-hover:h-auto lg:group-hover:mt-0 transition-all bg-white
                                    text-black rounded-lg shadow-lg `}
            >
