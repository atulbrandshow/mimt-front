    ...
    <div onClick={handleBackdropClick} className="fixed inset-0 flex items-center justify-center h-full pb-4 md:pt-20 backdrop-blur-md bg-black/60 z-[999999] px-2">
      <div ref={modalRef} className="relative bg-white rounded-lg shadow-lg max-w-md w-full overflow-hidden mt-10">
        <div className="bg-gray-100 flex flex-col justify-center items-center px-8 py-6 max-sm:py-6">
          <h2 className="text-sm text-gray-400 font-novaBold tracking-wider text-center">
            APPLY TODAY FOR
          </h2>
          <h1 className="mt-3 font-novaBold text-center text-xl max-sm:text-base">MIMT UNIVERSITY PROGRAMS</h1>
          <p className="bg-yellow-400 text-black text-center font-novaBold mb-6 max-sm:mb-0 text-xs w-max py-2 px-4 max-sm:px-2 max-sm:py-1.5 rounded-lg mt-2">
        ...
        <form className="p-6 max-sm:p-4" onSubmit={handleSubmit}>
          ...
          <div className="flex justify-between items-center">
            <Button
              ...
              className="bg-yellow-400 text-black font-novaBold py-4 px-12 max-sm:px-6 max-sm:py-3 text-xs rounded-md"
            />
