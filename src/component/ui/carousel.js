            ...
            <li
                ...
                >
                    ...
                    <div className="relative z-10 text-left">
                        ...
                        <div className="mt-4">
                            <Link href={link} className="px-2 md:px-4 py-1 md:py-2 rounded-md bg-secondary text-black text-[10px] sm:text-xs font-novaBold uppercase tracking-wide">View Details</Link>
                        </div>
                    </div>
                </article>
            </li>
